...
│                        LangGraph 状态机引擎                            │
│                                                                      │
│  需求收集 → JD生成 → JD审查 → 渠道发布 → 简历收集 → 简历初筛 →      │
│     ↓           ↓          ↓          ↓          ↓          ↓        │
│  AI澄清需求   RAG增强   人工审批   多平台     智能解析   AI评分排序    │
│                                                                      │
│  简历复筛 → 面试安排 → AI出题 → 面试 → AI评估 → Offer → 入职        │
│     ↓          ↓          ↓        ↓       ↓        ↓       ↓       │
│  精选候选 自动匹配   个性化   在线/  智能打分  名额校验 入职跟踪     │
│                     题目     线下                       & 培训       │
└──────────────────────────────────────────────────────────────────────┘
```
